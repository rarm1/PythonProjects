...
import optimisation_lib as opt_lib
...
def maths_functions(weekly_returns_list: list, df1: pandas.DataFrame):
...
def function_main():
    ...
    for idx, port in enumerate(all_ports_ex_zero):
        ...
        maths_functions(weekly_returns_arr, df_for_portfolio)
