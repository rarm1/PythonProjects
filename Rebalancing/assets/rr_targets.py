...
class RRTargets:
    def __init__(self):
        xlsx = pd.ExcelFile(r"X:\Fund Management\Fund Management Team Files\FM Personal Folders\Richard\PycharmProjects\Rebalancing\assets\New Targets Template.xlsx")
        ...
        print(rr_targets['Venture Targets'].to_string())
